...
# # ! <strong>Explanation:</strong> The <code>complex(1.25)</code>&nbsp; will convert 1.25 to the real part and the imaginary part is zero.
...
# # ! <strong>Explanation:</strong> We use float to denotes scientific numbers with an “e” to indicate the power of 10.
...
# # ! <strong>Explanation:</strong> <code>abs(x)</code> method returns the absolute value of x
...
# # ! <strong>Explanation:</strong> <code>(1.1 + 2.2)</code> is not equal to 3.3, It is <code>3.3000000000000003</code>. Use the <code>round()</code> function to compare exact values. For example: <code>print(round(1.1 + 2.2, 10) == round(3.3, 10))</code>
...
# # ! <strong>Explanation:</strong> In Python 3, Integer can have as many digits as your computer’s memory space allows.
...
# # ! <strong>Explanation</strong>: The <code>round()</code> function returns a rounded version of the specified floating-point number, with the specified number of decimals. The second argument of this function is the number of decimals to use when rounding the number.
...
# # ! <strong>Explanation:</strong> We can convert float to int using the <code>int()</code> constructor.
